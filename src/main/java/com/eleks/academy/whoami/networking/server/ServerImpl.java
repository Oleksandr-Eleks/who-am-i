...
public class ServerImpl implements Server {
	...
	private List<String> characters = List.of("Batman", "Superman", "AutoBot", "Dota");
	private List<String> questions = List.of("Am i a human?", "Am i a character from a movie?", "Am i a game?");
	private List<String> guessess = List.of("Batman", "Superman", "AutoBot", "Dota");
