...
public class RandomGame implements Game {
    ...
    public boolean makeTurn() {
        ...
        try {
            ...
            throw new ObtainPlayerNameException("Failed to obtain a player's name", e);
        }
    ...
    public void assignCharacters() {
        players.stream().map(Player::getName).parallel().map(f -> {
            ...
            try {
                ...
                throw new ObtainPlayerNameException("Player did not provide a name within %d %s".formatted(DURATION, UNIT));
            }
