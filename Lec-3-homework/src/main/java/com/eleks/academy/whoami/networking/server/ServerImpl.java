...
public class ServerImpl implements Server {
	...
	private List<String> characters = List.of("Batman", "Superman", "Flash", "Wonderwoman", "JMH");
	public List<String> questions = List.of("Am i a human?", "Am i a character from a movie?", "Am I woman? Am I from Mars? Am I lightning fast?");
	private List<String> guessess = List.of("Batman", "Superman", "Flash", "Wonderwoman", "JMH");
